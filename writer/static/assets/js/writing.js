(function() {
	...
	editButtons.forEach(function (editbtn) {
	  editbtn.addEventListener('click', function() {
		editbtn.innerHTML = '<i class="fas fa-circle-notch fa-spin"></i>';
		let fileValue = this.value;
		document.getElementById("uniquefile").setAttribute('value', ''+fileValue+'');
		...
		let itsTextEditor = document.querySelector('.ql-editor'),
		xhr = new XMLHttpRequest();
		xhr.onreadystatechange = function (e) {
			if (xhr.readyState == 4 && xhr.status == 200) {
				itsTextEditor.innerHTML = xhr.responseText;
				setTimeout(function(){
					document.getElementById('main').classList.remove('main-hidden');
					document.getElementById('files-wrap').classList.add('main-hidden');
				}, 300);
				editbtn.innerHTML = '<i class="fa-solid fa-pen-nib"></i>';
			}
		}
		xhr.open("GET", domainName+"/assets/doc/"+fileValue+".txt", true);
		xhr.setRequestHeader('Content-type', 'text/php');
		xhr.send();
		});
	});
	...
	document.getElementById('documents').addEventListener('click', function() {
		document.getElementById('main').classList.add('main-hidden');
	});
	...
	let currentYear = document.getElementById("latest-year"),
		...
		formSave = document.getElementById('save'),
		...
		output_field = document.getElementById("ai"),
		dl_output_field = document.getElementById("dl"),
		editor_field = document.getElementById("hiddenArea"),
	...
	let raffelHeadlines = document.getElementById("raffel-headlines"),
		...
		raffelHeadlines.addEventListener('click', function() {
			...
			promptTitle.setAttribute('name', "raffelHeadlines");
		...
		quizHeadlines.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "quizHeadlines");
		...
		clickbaitHeadlines.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "clickbaitHeadlines");
		...
		newsletterHeadlines.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "newsletterHeadlines");
		...
		newsletterIdeas.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "newsletterIdeas");
		...
		newsletterBody.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "newsletterBody");
		...
		pptSlides.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "pptSlides");
		...
		brainstormingIdeas.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "brainstormingIdeas");
		...
		surveyQuestions.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "suveryQuestions");
		...
		interviewQuestions.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "interviewQuestions");
		...
		classifiedAds.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "classifiedAds");
		...
		shortCta.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "shortCta");
		...
		coldCalling.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "coldCalling");
		...
		clickbaitEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "clickbaitEmail");
		...
		emailSeries.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "emailSeries");
			titleText.innerHTML = "Email series";
			optHeading.innerHTML = "Maximum no of emails";
			subHeading.innerHTML = "Describe your brand/product";
			formAction.action = '#';
		...
		smsMessages.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "smsMessages");
		...
		multichoiceAnswer.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "microchoiceAnswer");
		...
		blog.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "microblog");
		...
		blogTitle.addEventListener('click', function() {
			...
			promptTitle.setAttribute('name', "blogTitle");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		blogIntro.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "blogIntro");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		blogOutline.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "blogOutline");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		blogSection.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "blogSection");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		blogConclusion.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "blogConclusion");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		blogPara.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "blogPara");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		productDesc.addEventListener('click', function() {
			...
			formAction.action = '#';
			promptTitle.setAttribute('name', "productDesc");
		...
		longPr.addEventListener('click', function() {
			...
			formAction.action = '#';
			promptTitle.setAttribute('name', "longPr");
		...
		productTitle.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "productTitle");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		productBpoints.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "productBpoints");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		productBenefits.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "productBenefits");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		microPr.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "microPr");
			formSubmit.setAttribute('value', "Create");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		productResponse.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "productResponse");
			formSubmit.setAttribute('value', "Create");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		grammarCorrection.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "grammarCorrection");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		activeVoice.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "activeVoice");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		paraphraser.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "paraphraser");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		generaladCopy.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "generaladCopy");
		...
		googleDesc.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "googleDesc");
		...
		adHeadline.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "adHeadline");
		...
		fbprimaryText.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "fbprrimaryText");
		...
		liadCopy.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "liadCopy");
		...
		cta.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "cta");
			titleText.innerHTML = "Call To Action";
		...
		microCopy.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "microCopy");
	...
	- Fast, affordable, and works well on mobile devices`);
		...
		testimonial.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "testimonial");
		...
		metaDescription.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "metaDescription");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
		...
		metaKeyword.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "metaKeyword");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		productCopy.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "productCopy");
			templateWrap.style.display = "block";
			toneWrap.style.display = "block";
			formSubmit.setAttribute('value', "Create");
			removemMenuClass();
		...
		emailCopy.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "emailCopy");
			templateWrap.style.display = "block";
			toneWrap.style.display = "block";
			formSubmit.setAttribute('value', "Create");
			removemMenuClass();
		...
		brandName.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "brandName");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		brandMission.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "brandMission");
		...
		sloganGenerator.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "sloganGenerator");
		...
		valueProposition.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "valueProposition");
		...
		phLaunch.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "phLaunch");
		...
		welcomeEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "welcomeEmail");
	...
	Have a great day!`);
		...
		thankyouEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "thankyouEmail");
		...
		confirmationEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "confirmationEmail");
	...
	Have a great day!`);
		...
		followupEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "followupEmail");
	...
	Looking forward to hearing from you!`);
		...
		discountEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "discountEmail");
	...
	Limited time offer!`);
		...
		cancellationEmail.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "cancellationEmail");
	...
	Confirm your cancellation request`);
		...
		ytvideoScript.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "ytvideoScript");
			templateWrap.style.display = "block";
			toneWrap.style.display = "block";
			formSubmit.setAttribute('value', "Create");
			removemMenuClass();
		...
		ytvideoDesc.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "ytvideoDesc");
		...
		ytchannelDecs.addEventListener('click', function() {
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "ytchannelDecs");
		...
		yttitleGenerator.addEventListener('click', function() {
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "yttitleGenerator");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		gigDesc.addEventListener('click', function() {
			...
			promptTitle.setAttribute('name', "gigDesc");
		...
		gigTags.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "gigTags");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		gigStory.addEventListener('click', function() {
			...
			promptTitle.setAttribute('name', "gigStory");
		...
		gigResponse.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "gigResponse");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		gigAbout.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "gigAbout");
			formSubmit.setAttribute('value', "Create");
			templateWrap.style.display = "none";
			toneWrap.style.display = "block";
			removemMenuClass();
	...
	Additional instructions: `);
			...
			formSubmit.setAttribute('value', "Create");
			promptTitle.style.display = "none";
			promptTitle.setAttribute('name', "songLyrics");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
			toolsWrapper.style.display = "none";
		...
		obituaryGenerator.addEventListener('click', function() {
			...
			promptTitle.setAttribute('name', "obituaryGenerator");
			subHeading.innerHTML = "Enter song ideas";
			formAction.action = '#';
			userPrompt.setAttribute('placeholder', `e.g.
	First Name: John
	...
	Contact Person: molly@gmail.com`);
		...
		routineSets.addEventListener('click', function() {
			...
			outPut.style.display = "none";
			promptTitle.style.display = "block";
			promptTitle.setAttribute('name', "rouineSets");
			formSubmit.setAttribute('value', "Create");
			setTone.setAttribute('value', "");
			toneOption.selectedIndex = 0;
			removemMenuClass();
		...
		formSubmit.addEventListener('click', async function() {
			...
			var doc_tone = setTone.value;
			var doc_creativity = creativity.value;
			var qa = document.getElementById('q1').value;
			...
			.then(data => {
				...
				dl_output_field.innerHTML = '<pre>'+data['simplified']+'</pre>';
		...
		formSave.addEventListener('click', async function() {
			var complex = output_field.innerText;
			var simple = quillEditor.getText();
			...
			fetch(url, {method: "PUT", headers: new Headers({
				'X-CSRFToken': csrftoken,
				'Accept': 'application/json',
        		'X-Requested-With': 'XMLHttpRequest',}),
