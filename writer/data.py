...
def batchify(data, max_len=100): #max_len cutout defined by human
    ...
    for i, s in enumerate(data):
        ...
        # batch[i, s.shape[0]:] = 3
    return Variable(torch.from_numpy(batch)).cpu()
...
class Vocab():
    ...
    def add_vocab_from_file(self, vocab_file=r"writer\vocab_data\vocab.txt",vocab_size=30000):
...
class POSvocab():
    def __init__(self):
        ...
        self.count = 0
        self.embedding = None
        with open(r'writer\vocab_data\postag_set.p','rb') as f:
